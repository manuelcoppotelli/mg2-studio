...
_Questo documento può essere stampato utilizzando il comando di stampa presente nelle impostazioni di qualsiasi browser_.
...
Fra i Dati Personali raccolti da questo sito web, in modo autonomo o tramite terze parti, ci sono: Dati di utilizzo; Strumento di Tracciamento; risposte alle domande; clic; eventi keypress; eventi relativi ai sensori di movimento; movimenti del mouse; posizione relativa allo scorrimento; eventi touch.
...
I Dati dell'Utente sono raccolti per consentire al Titolare di fornire il Servizio, adempiere agli obblighi di legge, rispondere a richieste o azioni esecutive, tutelare i propri diritti ed interessi (o quelli di Utenti o di terze parti), individuare eventuali attività dolose o fraudolente, nonché per le seguenti finalità: Protezione dallo SPAM e Visualizzazione di contenuti da piattaforme esterne.
...
Google Maps è un servizio di visualizzazione di mappe gestito da Google Ireland Limited che permette a questa Applicazione di integrare tali contenuti all'interno delle proprie pagine.
...
Il Servizio fornito da questo sito web così come definito nei relativi termini (se presenti) su questo sito web.
