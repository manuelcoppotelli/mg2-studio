...
export default class SectionDynamicForm extends React.Component {
    render() {
            ...
            <section id={_.get(section, 'section_id', null)} className="block block-form outer">
              <div className="inner">
                ...
                <div className="block-content inner-sm">
                  ...
                  <form name={_.get(section, 'form_id', null)} id={_.get(section, 'form_id', null)} {...(_.get(section, 'form_action', null) ? ({action: _.get(section, 'form_action', null)}) : null)}method="POST" data-netlify="true" data-netlify-recaptcha="true" >
